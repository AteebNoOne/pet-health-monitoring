    ...
    const pickImage = async () => {
        try {
            ...
            const result = await ImagePicker.launchImageLibraryAsync({
                ...
                aspect: [1, 1], // Square crop for optimal model input
                quality: 0.8,
            });
    ...
    const detectEmotion = async () => {
        ...
        try {
            ...
            formData.append('image', {
                uri: selectedImage,
                name: filename || 'cat_photo.jpg',
                type: type,
            });

            // Append pet_id to form data
            ...
            Alert.alert(
                'Connection Error',
                'Failed to connect to server. Make sure your backend is running and the IP address is correct.'
            );
        } finally {
            setLoading(false);
        }
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Cat Emotion Detector</Text>
                <TouchableOpacity
                    style={styles.historyButton}
                    onPress={() => navigation.navigate('CatEmotionHistoryScreen', { pet })}
                >
            ...
            <View style={styles.petInfo}>
                ...
                />
                <Text style={styles.petName}>{pet?.pet_name || 'Unknown Cat'}</Text>
                <Text style={styles.subtitle}>How is your cat feeling?</Text>
            </View>
            ...
            {!selectedImage && !result && (
                <View style={styles.instructionsContainer}>
                    ...
                    <Text style={styles.instructionText}>1. Take a clear photo of your cat's face</Text>
...
export default CatEmotionScreen;
